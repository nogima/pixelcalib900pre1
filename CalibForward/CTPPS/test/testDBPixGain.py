...
process.pixGainDB = cms.EDAnalyzer("myCTPPSPixGainMaker",
    inputrootfile = cms.untracked.string('GainCalibration.root'),
    record = cms.untracked.string('CTPPSPixelGainCalibrationRcd')#,
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(
        cms.PSet(
            record = cms.string('CTPPSPixelGainCalibrationRcd'),
            tag = cms.string('CTPPSPixelGainCalib_TEST')
            )
        ),
    connect = cms.string('sqlite_file:ctppspix.db')
)
